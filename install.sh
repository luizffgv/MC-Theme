...
declare -A gtk3_asset_srcs=(
    ...
    ["headerbar_dark.png"]="block/cracked_nether_bricks.png@5x"
    ["headerbar_dark@2x.png"]="block/cracked_nether_bricks.png@10x"
    ["bg.png"]="block/stone.png@8x"
    ["bg@2x.png"]="block/stone.png@16x"
    ["bg_dark.png"]="block/nether_bricks.png@8x"
    ["bg_dark@2x.png"]="block/nether_bricks.png@16x"
    ["button.png"]="block/oak_planks.png@4x"
    ["button_dark.png"]="block/warped_planks.png@4x"
